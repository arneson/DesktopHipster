...
/**
 * This class is written only to test the different filters. The code is not
 * pretty because it isn't supposed to be a part of the final product.
 * 
...
public class FilterTestClass extends JFrame {
	...
	private void initialize() {
		...
		grayscale.addMouseListener(new MouseListener() {
			public void mouseClicked(MouseEvent e) {
				canvas.setFilterImage(ImageTools.applyGrayscale(canvas
						.getOriginalImage()));
			}
		...
		sepia.addMouseListener(new MouseListener() {
			public void mouseClicked(MouseEvent e) {
				canvas.setFilterImage(ImageTools.applySepia(canvas
						.getOriginalImage()));
			}
		...
		invertedGrayscale.addMouseListener(new MouseListener() {
			public void mouseClicked(MouseEvent e) {
				...
				canvas.setFilterImage(ImageTools.applyInvertedGrayscale(canvas
						.getOriginalImage()));
			}
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (result == JFileChooser.APPROVE_OPTION) {
					...
					try {
						...
						canvas.setFilterImage(ImageTools.applyLayer(
								canvas.getOriginalImage(), img));
